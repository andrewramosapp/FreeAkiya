  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <nav className="flex items-center justify-between px-6 py-5 max-w-5xl mx-auto border-b border-white/10">
        ...
        <Link href="/listings" className="text-gray-400 hover:text-white text-sm transition">
          ← All listings
        </Link>
      </nav>
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <span>/</span>
          <span className="text-gray-300">{listing.name}</span>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <p className="text-gray-400">🇯🇵 {listing.city}, {listing.prefecture} — {listing.region}</p>
              </div>
            </div>
            ...
            <div className="bg-[#e85d2f]/10 border border-[#e85d2f]/30 rounded-2xl p-6 mb-6">
              ...
              <div className="text-gray-400">{listing.priceJPY} · As listed</div>
            </div>
          ...
          <div className="lg:col-span-1">
              ...
              {!listing.isPremium && listing.contact ? (
                ...
                <>
                  <div className="bg-white/5 border border-white/10 rounded-xl p-4 mb-4">
                    <div className="text-[#e85d2f] text-sm font-medium mb-1">🔒 Premium listing</div>
                    <div className="text-gray-400 text-sm">Contact info and full details available to premium subscribers.</div>
                  </div>
                  <a href="/#signup"
                    className="block w-full bg-[#e85d2f] hover:bg-[#d44f23] text-white font-bold text-center py-3 rounded-full transition mb-3">
                    Unlock with Free Signup
                  </a>
                  <a href={listing.url} target="_blank" rel="noopener noreferrer"
            ...
            {/* Newsletter CTA */}
            <div className="bg-[#e85d2f]/10 border border-[#e85d2f]/20 rounded-2xl p-6">
              <div className="text-sm font-bold mb-2">📩 Get new listings weekly</div>
              <p className="text-gray-400 text-sm mb-4">Subscribe free and never miss an akiya under $10k.</p>
              <form action="https://www.beehiiv.com/subscribe" method="POST">
                ...
                <button type="submit"
                  className="w-full bg-[#e85d2f] hover:bg-[#d44f23] text-white font-bold py-2 rounded-full text-sm transition">
                  Subscribe Free →
                </button>
              </form>
            </div>
